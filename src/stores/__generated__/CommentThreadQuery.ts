...
// ====================================================
// GraphQL query operation: CommentThreadQuery
// ====================================================

export interface CommentThreadQuery_node_AddedToProjectEvent {
...
export interface CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_resolvedBy {
  __typename: "User";
  /**
...
export interface CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments_nodes_user_Bot {
...
export interface CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments_nodes_user_User {
  __typename: "User";
  /**
...
export type CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments_nodes_user = CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments_nodes_user_Bot | CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments_nodes_user_User;

export interface CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments_nodes_pullRequestReview {
...
export interface CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments_nodes {
   ...
   */
  user: CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments_nodes_user | null;
  /**
   ...
   */
  pullRequestReview: CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments_nodes_pullRequestReview | null;
}

export interface CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments_pageInfo {
  __typename: "PageInfo";
  /**
...
export interface CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments {
  __typename: "PullRequestReviewCommentConnection";
  /**
   * A list of nodes.
   */
  nodes: (CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments_nodes | null)[] | null;
  /**
   * Information to aid in pagination.
   */
  pageInfo: CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments_pageInfo;
}

export interface CommentThreadQuery_node_PullRequest_reviewThreads_edges_node {
   ...
   */
  resolvedBy: CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_resolvedBy | null;
  /**
   * A list of pull request comments associated with the thread.
   */
  comments: CommentThreadQuery_node_PullRequest_reviewThreads_edges_node_comments;
  /**
...
export interface CommentThreadQuery_node_PullRequest_reviewThreads_edges {
  __typename: "PullRequestReviewThreadEdge";
  /**
   * The item at the end of the edge.
   */
  node: CommentThreadQuery_node_PullRequest_reviewThreads_edges_node | null;
}

export interface CommentThreadQuery_node_PullRequest_reviewThreads_pageInfo {
  __typename: "PageInfo";
  /**
   * When paginating backwards, are there more items?
   */
...
export interface CommentThreadQuery_node_PullRequest_reviewThreads {
  __typename: "PullRequestReviewThreadConnection";
  /**
   * A list of edges.
   */
  edges: (CommentThreadQuery_node_PullRequest_reviewThreads_edges | null)[] | null;
  /**
   * Information to aid in pagination.
   */
  pageInfo: CommentThreadQuery_node_PullRequest_reviewThreads_pageInfo;
}

export interface CommentThreadQuery_node_PullRequest {
  __typename: "PullRequest";
  /**
   * The list of all review threads for this pull request.
   */
  reviewThreads: CommentThreadQuery_node_PullRequest_reviewThreads;
}

export type CommentThreadQuery_node = CommentThreadQuery_node_AddedToProjectEvent | CommentThreadQuery_node_PullRequest;

export interface CommentThreadQuery {
  /**
   * Fetches an object given its ID.
   */
  node: CommentThreadQuery_node | null;
}

export interface CommentThreadQueryVariables {
